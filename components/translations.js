...
export const uk = {
    ...
    about: "Про мене",
    about_desc: "Я - Junior Frontend розробник з Києва, добре володію технологіями HTML, CSS, React, Next.js і Tailwind. У мене також є досвід роботи з Bootstrap5 і Chakra UI. До того ж я відкритий до вивчення Typescript якщо це буде портібно для майбутніх проектів. Створюю та вдосконалюю адаптивні сайти, лендінги та інтернет-магазини. Маю 6 місяців досвіду фронтенд розробки та невпинну пристрасть до навчання, я продовжую вдосконалювати свої навички та знання. Окрім програмування, я навчаюся міжнародному менеджменту в університеті. Я також добре володію англійською (B1+) та маю гарні комунікативні навички.",
